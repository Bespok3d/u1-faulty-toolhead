# Faulty Toolhead 3 Bypass

A temporary recovery aid for the Snapmaker U1. When toolhead 3's thermistor fails, the printer
...
For toolhead 3 (`[extruder2]` + `[heater_fan e2_nozzle_fan]`):

- remaps the extruder `sensor_pin` to `e2:PC5`
...
- **Do not heat or print with toolhead 3 while this is enabled.** It only exists to let you boot
